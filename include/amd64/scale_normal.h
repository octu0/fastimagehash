#ifndef HALIDE__include___amd64___scale_normal_h
#define HALIDE__include___amd64___scale_normal_h
#include <stdint.h>
...
int scale_normal_par_for_scale_normal_s0_ch_par_for_scale_normal_s0_x_xo_ti_ti__2(void *__user_context, int32_t _scale_normal_s0_x_xo_ti_ti, uint8_t *_closure_arg__5);
HALIDE_FUNCTION_ATTRS
int scale_normal_par_for_scale_normal_s0_ch__2(void *__user_context, int32_t _scale_normal_s0_ch, uint8_t *_closure_arg__4);
HALIDE_FUNCTION_ATTRS
int scale_normal(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, int32_t _scale_width, int32_t _sale_height, struct halide_buffer_t *_scale_normal_buffer);

HALIDE_FUNCTION_ATTRS
int scale_normal_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *scale_normal_metadata();
