#ifndef HALIDE__include___arm64___scale_linear_h
#define HALIDE__include___arm64___scale_linear_h
#include <stdint.h>
...
int scale_linear_par_for_scale_linear_s0_ch_par_for_scale_linear_s0_x_xo_ti_ti__2(void *__user_context, int32_t _scale_linear_s0_x_xo_ti_ti, uint8_t *_closure_arg__5);
HALIDE_FUNCTION_ATTRS
int scale_linear_par_for_scale_linear_s0_ch__2(void *__user_context, int32_t _scale_linear_s0_ch, uint8_t *_closure_arg__4);
HALIDE_FUNCTION_ATTRS
int scale_linear(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, int32_t _scale_width, int32_t _sale_height, struct halide_buffer_t *_scale_linear_buffer);
