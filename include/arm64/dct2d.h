#ifndef HALIDE__include___arm64___dct2d_h
#define HALIDE__include___arm64___dct2d_h
#include <stdint.h>
...
int dct2d_par_for_dct2d_s0_y_y__2(void *__user_context, int32_t _dct2d_s0_y_y, uint8_t *_closure_arg__2);
HALIDE_FUNCTION_ATTRS
int dct2d(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_dct2d_buffer);

HALIDE_FUNCTION_ATTRS
int dct2d_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *dct2d_metadata();
