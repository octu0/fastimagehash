#ifndef HALIDE__include___arm64___grayscale_h
#define HALIDE__include___arm64___grayscale_h
#include <stdint.h>
...
int grayscale_par_for_grayscale_s0_ch_par_for_grayscale_s0_x_xo_ti_ti__2(void *__user_context, int32_t _grayscale_s0_x_xo_ti_ti, uint8_t *_closure_arg__5);
HALIDE_FUNCTION_ATTRS
int grayscale_par_for_grayscale_s0_ch__2(void *__user_context, int32_t _grayscale_s0_ch, uint8_t *_closure_arg__4);
HALIDE_FUNCTION_ATTRS
int grayscale(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_grayscale_buffer);
