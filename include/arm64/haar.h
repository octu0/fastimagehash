#ifndef HALIDE__include___arm64___haar_h
#define HALIDE__include___arm64___haar_h
#include <stdint.h>
...
int haar_par_for_haar_xy_lo_s0_x_xo_ti__2(void *__user_context, int32_t _haar_xy_lo_s0_x_xo_ti, uint8_t *_closure_arg__4);
HALIDE_FUNCTION_ATTRS
int haar_par_for_haar_xy_hi_s0_x_xo_ti__2(void *__user_context, int32_t _haar_xy_hi_s0_x_xo_ti, uint8_t *_closure_arg__5);
HALIDE_FUNCTION_ATTRS
int haar(struct halide_buffer_t *_src_buffer, int32_t _width, int32_t _height, struct halide_buffer_t *_haar_xy_lo_buffer, struct halide_buffer_t *_haar_xy_hi_buffer);

HALIDE_FUNCTION_ATTRS
int haar_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *haar_metadata();
